...
// A function which builds an SVG snippet on an SVG instance
type Snippetspec func(*SVG)
...
// Use a temporary SVG instance to create a snippet in a buffer, then write the snippet to our own writer
func (svg *SVG) genbuff(gen Snippetspec) {
	var b bytes.Buffer
	buffSvg := SVG{&b}
	gen(&buffSvg)
	b.WriteTo(svg.Writer)
}
...
// StartFunc begins and ends the SVG document with the width w and height h with the
// contents provided by the gen function.
// Other attributes may be optionally added, for example viewbox or additional namespaces
func (svg *SVG) StartFunc(gen Snippetspec, w int, h int, ns ...string) {
	svg.Start(w, h, ns...)
	svg.genbuff(gen)
	svg.End()
}
...
// StartunitFunc begins the SVG document, with width and height in the specified units
// with the contents provided by the gen function.
// Other attributes may be optionally added, for example viewbox or additional namespaces
func (svg *SVG) StartunitFunc(gen Snippetspec, w int, h int, unit string, ns ...string) {
	svg.Startunit(w, h, unit, ns...)
	svg.genbuff(gen)
	svg.End()
}
...
// StartpercentFunc begins the SVG document, with width and height as percentages
// with the contents provided by the gen function.
// Other attributes may be optionally added, for example viewbox or additional namespaces
func (svg *SVG) StartpercentFunc(gen Snippetspec, w int, h int, ns ...string) {
	svg.Startpercent(w, h, ns...)
	svg.genbuff(gen)
	svg.End()
}
...
// StartviewFunc begins the SVG document, with width, height, and viewbox with the
// contents provided by the gen function.
// Other attributes may be optionally added, for example viewbox or additional namespaces
func (svg *SVG) StartviewFunc(gen Snippetspec, w, h, minx, miny, vw, vh int) {
	svg.Startview(w, h, minx, miny, vw, vh)
	svg.genbuff(gen)
	svg.End()
}
...
// StartviewUnitFunc begins the SVG document, with width, height, and viewbox with the
// contents provided by the gen function.
// Other attributes may be optionally added, for example viewbox or additional namespaces
func (svg *SVG) StartviewUnitFunc(gen Snippetspec, w, h int, unit string, minx, miny, vw, vh int) {
	svg.StartviewUnit(w, h, unit, minx, miny, vw, vh)
	svg.genbuff(gen)
	svg.End()
}
...
// StartrawFunc begins the SVG document, passing arbitrary attributes with the
// contents provided by the gen function.
func (svg *SVG) StartrawFunc(gen Snippetspec, ns ...string) {
	svg.Startraw(ns...)
	svg.genbuff(gen)
	svg.End()
}
...
// GstyleFunc creates a group with the specified style with the contents generated by the
// gen function
func (svg *SVG) GstyleFunc(s string, gen Snippetspec) {
	svg.Gstyle(s)
	svg.genbuff(gen)
	svg.Gend()
}
...
// GtransformFunc creates a group with the specified trnsform with the contents generated
// by the gen function
func (svg *SVG) GtransformFunc(s string, gen Snippetspec) {
	svg.Gtransform(s)
	svg.genbuff(gen)
	svg.Gend()
}
...
// TranslateFunc creates a coordinate translation group with the specified translation
// containing the contents generated by the gen function
func (svg *SVG) TranslateFunc(x, y int, gen Snippetspec) {
	svg.Translate(x, y)
	svg.genbuff(gen)
	svg.Gend()
}
...
// Scale scales the coordinate system by n for a group containing the contents generated
// by the gen function
func (svg *SVG) ScaleFunc(n float64, gen Snippetspec) {
	svg.Scale(n)
	svg.genbuff(gen)
	svg.Gend()
}
...
// ScaleXY scales the coordinate system by dx and dy for a group containing the contents
// generated by the gen function
func (svg *SVG) ScaleXYFunc(dx, dy float64, gen Snippetspec) {
	svg.ScaleXY(dx, dy)
	svg.genbuff(gen)
	svg.Gend()
}
...
// SkewXFunc skews the x coordinate system by angle a for a group containing the contents
// generated by the gen function
func (svg *SVG) SkewXFunc(a float64, gen Snippetspec) {
	svg.SkewX(a)
	svg.genbuff(gen)
	svg.Gend()
}
...
// SkewYFunc skews the y coordinate system by angle a for a group containing the contents
// generated by the gen function
func (svg *SVG) SkewYFunc(a float64, gen Snippetspec) {
	svg.SkewY(a)
	svg.genbuff(gen)
	svg.Gend()
}
...
// SkewXYFunc skews the x and y coordinates by angle ax, ay respectively for a group
// containing the contents generated by the gen function
func (svg *SVG) SkewXYFunc(ax, ay float64, gen Snippetspec) {
	svg.SkewXY(ax, ay)
	svg.genbuff(gen)
	svg.Gend()
}
...
// Rotate rotates the coordinate system by r degrees for a group containing the contents generated by
// the gen function
func (svg *SVG) RotateFunc(r float64, gen Snippetspec) {
	svg.Rotate(r)
	svg.genbuff(gen)
	svg.Gend()
}
...
// TranslateRotate translates the coordinate system to (x, y), then rotates to r degrees for a group
// containing the contents generated by the gen function
func (svg *SVG) TranslateRotateFunc(x, y int, r float64, gen Snippetspec) {
	svg.TranslateRotate(x, y, r)
	svg.genbuff(gen)
	svg.Gend()
}
...
// RotateTranslate rotates the coordinate system r degrees, then translate to (x, y) for a group
// containing the contents generated by the gen function
func (svg *SVG) RotateTranslateFunc(x, y int, r float64, gen Snippetspec) {
	svg.RotateTranslate(x, y, r)
	svg.genbuff(gen)
	svg.Gend()
}
...
// Group begins a group with arbitrary attributes for a group containing the contents generated by the
// gen function
func (svg *SVG) GroupFunc(gen Snippetspec, s ...string) {
	svg.Group(s...)
	svg.genbuff(gen)
	svg.Gend()
}
...
// Gid begins a group with the specified id containing the contents generated by the gen function
func (svg *SVG) GidFunc(gen Snippetspec, s string) {
	svg.Gid(s)
	svg.genbuff(gen)
	svg.Gend()
}
...
// ClipPathFunc defines a clip path containing the contents generated by the gen function
func (svg *SVG) ClipPathFunc(gen Snippetspec, s ...string) {
	svg.ClipPath(s...)
	svg.genbuff(gen)
	svg.ClipEnd()
}
...
// DefFunc defines a definition block containing the contents generated by the gen function
func (svg *SVG) DefFunc(gen Snippetspec) {
	svg.Def()
	svg.genbuff(gen)
	svg.DefEnd()
}
...
// MarkerFunc defines a marker containing the contents generated by the gen function
func (svg *SVG) MarkerFunc(id string, x, y, width, height int, gen Snippetspec, s ...string) {
	svg.Marker(id, x, y, width, height, s...)
	svg.genbuff(gen)
	svg.MarkerEnd()
}
...
// PatternFunc defines a pattern containing the contents generated by the gen function
func (svg *SVG) PatternFunc(id string, x, y, width, height int, putype string, gen Snippetspec, s ...string) {
	svg.Pattern(id, x, y, width, height, putype, s...)
	svg.genbuff(gen)
	svg.PatternEnd()
}
...
// LinkFunc defines a link containing the contents generated by the gen function
func (svg *SVG) LinkFunc(href string, title string, gen Snippetspec) {
	svg.Link(href, title)
	svg.genbuff(gen)
	svg.LinkEnd()
}
...
// LinkFunc defines a link containing the contents generated by the gen function
func (svg *SVG) MaskFunc(id string, x, y, w, h int, gen Snippetspec, s ...string) {
	svg.Mask(id, x, y, w, y, s...)
	svg.genbuff(gen)
	svg.MaskEnd()
}
...
// TextStart draws text using the style specified in s, end with TextEnd()
// Standard Reference: http://www.w3.org/TR/SVG11/text.html#TextElement
func (svg *SVG) TextStart(s ...string) {
	svg.printf(`<text %s`, endstyle(s, ">"))
}

func (svg *SVG) TextRaw(t string) {
	xml.Escape(svg.Writer, []byte(t))
}

func (svg *SVG) TextFunc(gen Snippetspec, s ...string) {
	svg.TextStart(s...)
	svg.genbuff(gen)
	svg.TextEnd()
}
...
// TextspanFunc draws text at a specified location containing the contents generated by the gen function
// Standard Reference: https://www.w3.org/TR/SVG11/text.html#TSpanElement
func (svg *SVG) TextspanFunc(x int, y int, gen Snippetspec, s ...string) {
	svg.TextStart(append(s, loc(x, y))...)
	svg.genbuff(gen)
	svg.TextEnd()
}
...
// Span makes styled spanned text, should be proceeded by Textspan
// Standard Reference: https://www.w3.org/TR/SVG11/text.html#TSpanElement
func (svg *SVG) SpanRaw(s ...string) {
	svg.printf(`<tspan %s`, endstyle(s, ">"))
}

func (svg *SVG) SpanFunc(gen Snippetspec, s ...string) {
	svg.SpanRaw(s...)
	svg.genbuff(gen)
	svg.SpanEnd()
}

// SpanEnd ends a SpanRaw
// Standard Reference: https://www.w3.org/TR/SVG11/text.html#TSpanElement
func (svg *SVG) SpanEnd() {
	svg.printf(`</tspan>`)
}
...
// Textpath places text optionally styled text along a previously defined path
// Standard Reference: http://www.w3.org/TR/SVG11/text.html#TextPathElement
func (svg *SVG) TextpathRaw(pathid string, s ...string) {
	svg.printf("<textPath xlink:href=\"%s\" %s", pathid, endstyle(s, ">"))
}

func (svg *SVG) TextpathFunc(pathid string, gen Snippetspec, s ...string) {
	svg.TextpathRaw(pathid, s...)
	svg.genbuff(gen)
	svg.TextPathEnd()
}

func (svg *SVG) TextPathEnd() {
...
// FilterFunc creates a filter containing the contents generated by the gen function
func (svg *SVG) FilterFunc(id string, gen Snippetspec, s ...string) {
	svg.Filter(id, s...)
	svg.genbuff(gen)
	svg.Fend()
}
...
// FeComponentTransferEnd creates a feComponent filter with the contents generated by the gen function
func (svg *SVG) FeComponentTransferFunc(gen Snippetspec) {
...
// FeDiffuseLightingFunc creates a diffulse lighting filter with the contents generated by the gen function
func (svg *SVG) FeDiffuseLightingFunc(fs Filterspec, scale, constant float64, gen Snippetspec, s ...string) {
	svg.FeDiffuseLighting(fs, scale, constant, s...)
	svg.genbuff(gen)
	svg.FeDiffEnd()
}
...
// FeSpecularLightingFunc creates a specular lighting filter with the contents generated by the gen function
func (svg *SVG) FeSpecularLightingFunc(fs Filterspec, scale, constant float64, exponent int, color string, gen Snippetspec, s ...string) {
	svg.FeSpecularLighting(fs, scale, constant, exponent, color, s...)
	svg.genbuff(gen)
	svg.FeSpecEnd()
}
